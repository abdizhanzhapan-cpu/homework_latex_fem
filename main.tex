...
\fancyhead[R]{Homework Report \#xx}
\fancyfoot[C]{\thepage}
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\footrulewidth}{0.4pt}

% images looked for under figs/ as well
\graphicspath{{figs/}}
...
\begin{figure}[h]
  \centering
  \IfFileExists{p1_u.png}{\includegraphics[width=.7\linewidth]{p1_u.png}}{\fbox{\rule{0pt}{3cm}\rule{.7\linewidth}{0pt}}}
  \caption{Graph of \(u(x)\) for Problem 1}
\end{figure}

\begin{figure}[h]
  \centering
  \IfFileExists{p1_up.png}{\includegraphics[width=.7\linewidth]{p1_up.png}}{\fbox{\rule{0pt}{3cm}\rule{.7\linewidth}{0pt}}}
  \caption{Graph of \(u'(x)\) for Problem 1}
\end{figure}
...
\begin{figure}[h]
  \centering
  \IfFileExists{figs/p2_up.png}{\includegraphics[width=.7\linewidth]{figs/p2_up.png}}{\fbox{\rule{0pt}{3cm}\rule{.7\linewidth}{0pt}}}
  \caption{Graph of \(u'(x)\) for Problem 2}
\end{figure}
...
\begin{figure}[h]
  \centering
  \IfFileExists{figs/p3_u.png}{\includegraphics[width=.7\linewidth]{p3_u.png}}{\fbox{\rule{0pt}{3cm}\rule{.7\linewidth}{0pt}}}
  \caption{Graph of \(u(x)\) for Problem 3}
\end{figure}

\begin{figure}[h]
  \centering
  \IfFileExists{figs/p3_up.png}{\includegraphics[width=.7\linewidth]{p3_up.png}}{\fbox{\rule{0pt}{3cm}\rule{.7\linewidth}{0pt}}}
  \caption{Graph of \(u'(x)\) for Problem 3}
\end{figure}

\begin{figure}[h]
  \centering
  \IfFileExists{figs/p3_upp.png}{\includegraphics[width=.7\linewidth]{p3_upp.png}}{\fbox{\rule{0pt}{3cm}\rule{.7\linewidth}{0pt}}}
  \caption{Graph of \(u''(x)\) for Problem 3}
\end{figure}

\begin{figure}[h]
  \centering
  \IfFileExists{figs/p3_uppp.png}{\includegraphics[width=.7\linewidth]{p3_uppp.png}}{\fbox{\rule{0pt}{3cm}\rule{.7\linewidth}{0pt}}}
